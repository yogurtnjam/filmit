          ...
          <div className="hidden lg:block space-y-8 animate-slide-up">
            ...
            <div className="space-y-4">
              <div className="group flex items-start gap-4 p-5 bg-card rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-md">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1 text-lg">Trend Analysis</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">AI analyzes trending formats across YouTube, TikTok, and Instagram in real-time</p>
                </div>
              </div>
              ...
              <div className="group flex items-start gap-4 p-5 bg-card rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-md">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1 text-lg">Real-Time Feedback</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">Get instant recommendations on content structure and optimal posting format</p>
                </div>
              </div>
              ...
              <div className="group flex items-start gap-4 p-5 bg-card rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-md">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1 text-lg">Performance Insights</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">Track what works and optimize your content strategy with data-driven insights</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="border-border/50 shadow-xl backdrop-blur-sm bg-card/95">
              <CardHeader className="space-y-2 pb-6">
                ...
                <CardDescription className="text-muted-foreground">
                  Connect your platforms to get started with AI-powered content insights
                </CardDescription>
              </CardHeader>
                ...
                <div className="space-y-3">
                  {socialProviders.map((provider) => (
                    <Button
                      key={provider.name}
                      variant="outline"
                      className="w-full justify-start gap-3 h-12 hover:bg-primary/5 hover:border-primary/40 transition-all duration-300 group"
                      onClick={() => handleSocialLogin(provider.name)}
                      disabled={isLoading}
                    >
                      <span className="group-hover:scale-110 transition-transform duration-300">{provider.icon}</span>
                      <span className="flex-1 text-left font-medium">Continue with {provider.name}</span>
                    </Button>
                  ))}
                </div>
